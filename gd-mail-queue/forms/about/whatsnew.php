...
<div class="d4p-about-whatsnew">
    ...
    <div class="d4p-whatsnew-section">
        <div class="d4p-layout-grid">
            ...
            <div class="d4p-layout-unit half align-left">
                <img src="https://dev4press.s3.amazonaws.com/plugins/gd-mail-queue/3.0/about/log.jpg" alt="Log"/>
            </div>
        </div>
    </div>
    ...
    <div class="d4p-whatsnew-section">
        <div class="d4p-layout-grid">
            <div class="d4p-layout-unit half align-left">
                ...
                <p>
                    Plugin can intercept all emails sent through the wp_mail function and decide what needs to be done with it (turn to HTML or added to queue depending on the number of email recipients), based on the plugin settings.
                </p>
            </div>
            <div class="d4p-layout-unit half align-left">
    ...
    <div class="d4p-whatsnew-section">
        <div class="d4p-layout-grid">
            <div class="d4p-layout-unit half align-left">
                ...
                <p>
                    If email has more then one TO recipient, CC and or BCC recipients, plugin will take that one email and generated multiple emails based on it where all recipients receive individual emails. Each new email is added to the database.
                </p>
            </div>
            <div class="d4p-layout-unit half align-left">
                <h3>Adjustable queue mailing</h3>
                <p>
                    Queue is processed in the background (using CRON job), and you can adjust the period for the queue processing (5 minutes default), number of emails to send in a batch, and timeout allowed for server not to break the execution.
                </p>
            </div>
        </div>
    </div>
