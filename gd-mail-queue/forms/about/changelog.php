...
<div class="d4p-group d4p-group-changelog">
    ...
    <div class="d4p-group-inner">
        <h4>Version: 4.4 / december 3 2024</h4>
        <ul>
            <li><strong>new</strong> plugin tested with WordPress up to 6.7</li>
            <li><strong>new</strong> plugin tested with PHP up to 8.4</li>
            <li><strong>edit</strong> proper sanitization of the HTML classes</li>
            <li><strong>edit</strong> d4pLib 2.8.20</li>
            <li><strong>fix</strong> cross site scripting problem with the admin error messages</li>
        </ul>
